...
BasePlusCommissionEmployee::BasePlusCommissionEmployee(
   ...
   :data(first,last,ssn,sales,rate)
   ...
   const string &ssn )
{
   ...
   data.setSocialSecurityNumber(ssn);
...
string BasePlusCommissionEmployee::getSocialSecurityNumber() const
{
   ...
   return  data.getSocialSecurityNumber();
...
{
   return getBaseSalary() + data.earnings();
